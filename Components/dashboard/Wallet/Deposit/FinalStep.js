            ...
            <Modal hideModal={()=>handleCurrentStep('')}>
                <div className={classes.finalStep}>
                    <div className={classes['order-approved']}>
                        ...
                        <p className='fs-16 fw-400 secondary-color'>Your <span className="fw-600 tetiary-color">Deposit Order</span> has been approved. Your money is on it’s way to you</p>
                    </div>
